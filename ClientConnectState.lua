...
function ClientConnectState:draw()
	...
	love.graphics.draw(self.drinking, 150, 30 + 20*math.sin(self.time*3))
	love.graphics.draw(self.is, 325, 150 + 20*math.sin(self.time*3 + 2))
	love.graphics.draw(self.fun, 370, 300 + 40*math.sin(self.time*5 + 5), nil, 0.2+math.abs(math.sin(self.time)), 0.2+math.abs(math.sin(self.time)), 106, 57.5)
